export const allProjects = [
  ...
  },
  {
    ...
    overview:
      "Koraq is a cross-platform mobile app that acts as an intelligent business assistant for small and medium enterprises. It automates routine reporting, surfaces key insights, and handles client follow-ups, giving owners hours back every week.",
    challenge:
    ...
    solution:
      "React Native for cross-platform delivery on iOS and Android. GPT-4 API handles natural language report generation and insights. Supabase stores business data. Push notifications drive automated reminders and follow-up prompts.",
    results: [
      "Saves business owners 5+ hours per week on average",
      "Shipped on both iOS and Android from a single codebase",
    ...
    features: [
      ...
      { num: "04", title: "Cross-Platform",        desc: "One codebase, fully native feel and performance on both iOS and Android." },
    ],
  },
  {
    title: "Bitvest App",
    slug: "bitvest-app",
    category: "App",
    tags: "Fintech · React Native · Mobile",
    excerpt: "Mobile investment app with biometric auth, portfolio management, and real-time market data.",
    image: "/images/bitvest-app.png",
    link: "#",
    year: "2025",
    duration: "8 weeks",
    role: "Mobile Developer",
    overview:
      "The BitVest mobile app brings the full investment platform experience to iOS and Android. Users can monitor portfolios, execute transactions, and receive market alerts, with enterprise-grade security baked in from day one.",
    challenge:
    ...
    solution:
      "React Native for cross-platform delivery. Biometric auth via Expo LocalAuthentication. React Query for efficient data fetching and seamless background sync. Custom chart components optimized for touch interaction and small screens.",
    results: [
      "Full feature parity with the web platform from a single codebase",
      "Biometric auth works across Face ID and fingerprint devices",
  ...
  },
  {
    ...
    slug: "ppay",
    category: "App",
    tags: "Payments · React Native · Cross-Platform",
    ...
    solution:
      "React Native with Expo for rapid cross-platform delivery. Flutterwave for payment processing. An offline-capable transaction queue that syncs when connectivity returns. End-to-end transaction encryption.",
    results: [
  ...
  },
  {
    ...
    slug: "velau",
    category: "App",
    tags: "Trading · Automation · React Native",
    ...
    solution:
      "React Native frontend with a visual strategy builder built around simple if-then logic. Python backend for market data ingestion and trade execution. Real-time portfolio PnL via WebSocket connections.",
    results: [
